// src/lib.rs
/*
 * Core library for AcousticForge
 */
...
#[derive(Debug)]
pub struct AcousticForgeProcessor {
    verbose: bool,
    processed_count: usize,
}

impl AcousticForgeProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting AcousticForge processing");
    
    let mut processor = AcousticForgeProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = AcousticForgeProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = AcousticForgeProcessor::new(false);
